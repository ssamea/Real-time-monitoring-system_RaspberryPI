...
price = ["4000원", "4500원", "1500원", "2000원", "2000원", "4500원", "5000원", "2500원", "4000원", "5000원", "4500원", "4500원"] #음식 가격 넣을 리스트
menu = ["제육볶음", "김치볶음밥", "일반주먹밥", "김치주먹밥", "참치주먹밥", "볼케이노치밥", "스팸마요덮밥", "라면", "오므라이스", "부대찌개", "뚝배기불고기", "돈까스"]#메뉴 넣을 리스트
...
class MyWindow(QWidget): #GUI창 설정
    ...
    def __init__(self):
        ...
        self.btn1 = PicButton(QPixmap('../JongHap/img1.jpg')) #버튼이미지를 가져올 경로
        ...
        self.btn2 = PicButton(QPixmap('../JongHap/img2.jpg'))
        ...
        self.btn3 = PicButton(QPixmap('../JongHap/img3.jpg'))
        ...
        self.btn4 = PicButton(QPixmap('../JongHap/img4.jpg'))
        ...
        self.btn5 = PicButton(QPixmap('../JongHap/img5.jpg'))
        ...
        self.btn6 = PicButton(QPixmap('../JongHap/img6.jpg'))
        ...
        self.btn7 = PicButton(QPixmap('../JongHap/img7.jpg'))
        ...
        self.btn8 = PicButton(QPixmap('../JongHap/img8.jpg'))
        ...
        self.btn9 = PicButton(QPixmap('../JongHap/img9.jpg'))
        ...
        self.btn10 = PicButton(QPixmap('../JongHap/img10.jpg'))
        ...
        self.btn11 = PicButton(QPixmap('../JongHap/img11.jpg'))
        ...
        self.btn12 = PicButton(QPixmap('../JongHap/img12.jpg'))
    ...
    def btn_order(self):
        ...
        if (self.tableWidget.item(0, 0) is None): #첫번째 줄이 비어있으면
            ...
            db.reference('Restaurant_DB/Real_time/JongHap').push({
