...
price = ["2500원", "2500원", "3000원", "4500원", "5000원", "4500원", "4000원", "5500원", "4500원", "5000원", "4000원", "3500원"] #음식 가격 넣을 리스트
menu = ["치즈김밥", "마요네즈김밥", "잔치국수", "제육덮밥", "갈비탕", "제육덮밥", "김치볶음밥", "스페셜떡볶이", "비빔냉면", "부대찌개", "물냉면", "냉모밀"]#메뉴 넣을 리스트
...
class MyWindow(QWidget): #GUI창 설정
    ...
    def __init__(self):
        ...
        self.btn1 = PicButton(QPixmap('../Sanyung/img1.jpg')) #버튼이미지를 가져올 경로
        ...
        self.btn2 = PicButton(QPixmap('../Sanyung/img2.jpg'))
        ...
        self.btn3 = PicButton(QPixmap('../Sanyung/img3.jpg'))
        ...
        self.btn4 = PicButton(QPixmap('../Sanyung/img4.jpg'))
        ...
        self.btn5 = PicButton(QPixmap('../Sanyung/img5.jpg'))
        ...
        self.btn6 = PicButton(QPixmap('../Sanyung/img6.jpg'))
        ...
        self.btn7 = PicButton(QPixmap('../Sanyung/img7.jpg'))
        ...
        self.btn8 = PicButton(QPixmap('../Sanyung/img8.jpg'))
        ...
        self.btn9 = PicButton(QPixmap('../Sanyung/img9.jpg'))
        ...
        self.btn10 = PicButton(QPixmap('../Sanyung/img10.jpg'))
        ...
        self.btn11 = PicButton(QPixmap('../Sanyung/img11.jpg'))
        ...
        self.btn12 = PicButton(QPixmap('../Sanyung/img12.jpg'))
