...
price = ["4000원", "5000원", "5000원", "4000원", "4500원", "2500원", "4500원", "2500원", "4000원", "5000원", "3500원", "4000원"] #음식 가격 넣을 리스트
menu = ["야끼우동", "짜글이", "치즈돈까스", "냉모밀", "부타동", "라면", "마불덮밥", "컵닭강정", "김치찌개", "돈까스김치나베", "모듬컵밥", "꼬치어묵우동"]#메뉴 넣을 리스트
...
class MyWindow(QWidget): #GUI창 설정
    ...
    def __init__(self):
        ...
        self.btn1 = PicButton(QPixmap('../TIP/img1.jpg')) #버튼이미지를 가져올 경로
        ...
        self.btn2 = PicButton(QPixmap('../TIP/img2.jpg'))
        ...
        self.btn3 = PicButton(QPixmap('../TIP/img3.jpg'))
        ...
        self.btn4 = PicButton(QPixmap('../TIP/img4.jpg'))
        ...
        self.btn5 = PicButton(QPixmap('../TIP/img5.jpg'))
        ...
        self.btn6 = PicButton(QPixmap('../TIP/img6.jpg'))
        ...
        self.btn7 = PicButton(QPixmap('../TIP/img7.jpg'))
        ...
        self.btn8 = PicButton(QPixmap('../TIP/img8.jpg'))
        ...
        self.btn9 = PicButton(QPixmap('../TIP/img9.jpg'))
        ...
        self.btn10 = PicButton(QPixmap('../TIP/img10.jpg'))
        ...
        self.btn11 = PicButton(QPixmap('../TIP/img11.jpg'))
        ...
        self.btn12 = PicButton(QPixmap('../TIP/img12.jpg'))
    ...
    def btn_order(self):
        ...
        if (self.tableWidget.item(0, 0) is None): #첫번째 줄이 비어있으면
            ...
            db.reference('Restaurant_DB/Real_time/TIP').push({
